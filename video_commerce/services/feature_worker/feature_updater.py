...
Usage:
    python -m video_commerce.services.feature_worker.feature_updater
"""
...
from video_commerce.data_plane.kafka_client import KafkaConsumerClient, KafkaManager, get_kafka_manager
